        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav {{routeActive('sample-page')}}" href="{{ route('sample-page') }}"><i data-feather="file"></i><span>form Anak Yatim</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{routeActive('internationalization')}}" href="{{ route('internationalization') }}"><i data-feather="aperture"></i><span>form Anak Yatim</span></a>
                    </li>
                    <li class="mega-menu">
